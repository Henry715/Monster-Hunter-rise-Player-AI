...
## 4/22
now the Server sends the quest info to the client only after the hunt starts. Put the stats folder inside the auto run folder generated by reframework. And remember to download the MHR-Overlay as well, as I have used the quest_status module from there.
# File location
